...
<!--
            <li><a href="#">Subscribe</a>
                <ul>
                    <?php if (get_option('mmminimal_twitter') != '') { ?><li><a href="http://twitter.com/<?php echo get_option('mmminimal_twitter'); ?>" title="Follow <?php bloginfo('name'); ?> on Twitter" target="_blank">Twitter</a></li><?php } ?>
                    <li><a href="<?php if ($feedburner != '') { echo 'http://feeds.feedburner.com/'.$feedburner; } else { bloginfo('rss2_url'); } ?>">RSS Feed</a></li>
                </ul>
            </li>
-->
